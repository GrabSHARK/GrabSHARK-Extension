 ...
 * 
 * Features:
 * - Detect navbar/header height (GrabSHARK modal headers)
...
export class ActionBarPositioner {
     ...
     * Detects GrabSHARK's modal header to properly clamp the action bar
     */
     ...
     * Detects GrabSHARK's scroll container bottom to properly clamp the action bar
     */
