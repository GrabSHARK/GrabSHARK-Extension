            ...
            {showCaptureConfirmation && (
                <div className={`absolute inset-0 bg-black/50 z-50 flex flex-col items-center justify-center text-white backdrop-blur-sm rounded-xl p-6 transition-opacity duration-200 ${captureOverlayVisible ? 'opacity-100' : 'opacity-0'}`}>
                    ...
                    <button
                        ...
                        className="px-6 py-2.5 bg-primary hover:bg-primary/90 text-primary-foreground font-semibold rounded-full text-sm transition-all shadow-[0_0_20px_hsl(var(--primary)/0.3)] hover:shadow-[0_4px_15px_rgba(0,0,0,0.2),0_0_28px_hsl(var(--primary)/0.45)]"
                    >
                        Start
                    </button>
